//#region node_modules/.nitro/vite/services/ssr/assets/demo-data-B2rfthtF.js
/**
...
var DEMO_PREDICTIONS = [
	...
	},
	{
		...
		signals: [
			...
			{
				label: "Charging nearby",
				value: "Library · Block B",
				tone: "good"
			}
		],
...
var DEMO_MARKERS = [
	{
		...
		x: 22,
		y: 68,
		detail: "At home · location sharing off"
	},
	{
		id: "t1",
		label: "JNTU junction",
...
var DEMO_SIMULATION = [
	...
	},
	{
		...
		detail: "One-tap: start navigation on Route B."
	}
];
var DEMO_ANALYTICS = {
...
var DEMO_CITY = {
	hotspots: [
		{
			name: "JNTU junction",
			level: 88,
			note: "Congestion hotspot · 07:40–09:20"
		},
		{
			name: "Miyapur corridor",
			level: 74,
			note: "Slow-moving traffic after rain"
		},
		{
			name: "KPHB metro exit",
			level: 66,
			note: "High pedestrian density"
		},
		{
			name: "Balanagar flyover",
			level: 51,
			note: "Recovering from earlier incident"
		}
	],
	crowd: [
		{
	...
	anomalies: [
		{
			label: "Air quality dip",
			detail: "PM2.5 up 22% vs. 7-day mean in the industrial belt"
		},
		{
			label: "Waterlogging signal",
			detail: "3 aggregated reports near the underpass"
		},
		{
			label: "Noise spike",
			detail: "Sustained 78 dB near the construction zone"
		}
	],
	infrastructure: [
		{
		...
		},
		{
			label: "Signal fault",
			count: 3,
			area: "Central junction"
		}
	],
	predictedZones: [
		{
			name: "Underpass corridor",
			risk: "High",
			window: "17:30–19:00"
		},
		{
...
var DEMO_SCHEDULE = [
	...
	{
		time: "8:00 PM",
		title: "Study block — DBMS",
		place: "Quiet zone",
		kind: "study"
	}
];
//#endregion
export { DEMO_HISTORY as a, DEMO_PREDICTIONS as c, DEMO_TASKS as d, DEMO_CONTEXT as i, DEMO_SCHEDULE as l, DEMO_ANALYTICS as n, DEMO_MARKERS as o, DEMO_CITY as r, DEMO_MEMORIES as s, DEMO_AGENTS as t, DEMO_SIMULATION as u };
