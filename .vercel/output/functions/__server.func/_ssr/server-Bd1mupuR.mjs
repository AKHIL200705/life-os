...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-Bd1mupuR.js
var server_Bd1mupuR_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D2VJem0v.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-8w0n-NVQ.mjs").then((n) => n.t),
		import("./start-Csq6Zzob.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_Bd1mupuR_exports as t };
