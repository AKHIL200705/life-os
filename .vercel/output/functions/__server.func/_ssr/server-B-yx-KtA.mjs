...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-B-yx-KtA.js
var server_B_yx_KtA_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dfc_k3pb.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BvJIRm2k.mjs").then((n) => n.t),
		import("./start-CChIyLcj.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_B_yx_KtA_exports as t };
